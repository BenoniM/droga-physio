  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden text-[#1A1A1A]">
      ...
      <div className="pt-32 pb-24 px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto min-h-screen">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-16 lg:gap-24 mt-12">
          
          {/* ── LEFT COLUMN: BOOKING FORM ──────────────────────────────── */}
          <div className="flex flex-col xl:pr-6">
            
            <h1 className="text-3xl md:text-[2.2rem] lg:text-[2.6rem] xl:text-[2.8rem] font-medium leading-[1.3] text-[#111] mb-12">
              Book Appointment
            </h1>
            ...
            <form className="w-full flex flex-col" onSubmit={(e) => e.preventDefault()}>
              ...
              <input 
                ...
                className="w-full pb-4 mb-10 text-[16px] xl:text-[17px] border-b border-[#E1DDE6] placeholder-[#A29CA8] text-[#333] outline-none focus:border-[#745893] transition-colors bg-transparent font-light"
              />
              ...
              <div className="relative w-full mb-10">
                <select className="w-full pb-4 text-[16px] xl:text-[17px] border-b border-[#E1DDE6] text-[#A29CA8] outline-none focus:border-[#745893] transition-colors bg-transparent font-light appearance-none cursor-pointer">
                ...
                <div className="absolute right-2 top-1/3 -translate-y-1/2 pointer-events-none text-gray-400">
              ...
              <input 
                type="date" 
                className="w-full p-4 mb-12 text-[16px] xl:text-[17px] border border-[#E1DDE6] rounded-xl text-[#A29CA8] outline-none focus:border-[#745893] transition-colors bg-transparent font-light"
              />

              {/* Rich Text Editor */}
              <div className="w-full border border-[#E1DDE6] rounded-xl mb-10 overflow-hidden bg-white focus-within:border-[#745893] transition-colors shadow-sm">
                <div className="border-b border-[#E1DDE6] px-5 py-3 flex items-center gap-5 text-gray-500 bg-[#FAF7FB]">
                ...
                <div 
                  ...
                  className="w-full p-5 outline-none bg-transparent font-sans text-[16px] text-[#333] min-h-[160px] cursor-text empty:before:content-[attr(data-placeholder)] empty:before:text-[#A29CA8]"
                ></div>
              </div>

              {/* Submit Button */}
              <div>
                <button type="submit" className="bg-[#FFF200] text-black font-semibold text-[12px] px-9 py-4 rounded-full flex items-center justify-center gap-3 hover:scale-105 transition-transform w-[240px] shadow-sm">
                  Book An Appointment
          ...
          <div className="relative w-full h-[650px] lg:h-full min-h-[700px] rounded-[20px] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.06)] bg-[#f3f4f6]">
            ...
            <a
              ...
              className="absolute top-6 left-6 bg-[#745893] text-white text-[13px] font-medium px-5 py-3 rounded flex items-center gap-2 hover:bg-[#5b4375] transition shadow-md z-10 tracking-wide"
            >
              View In Maps
            ...
            <div 
              ...
              className="absolute bottom-6 left-6 w-[70px] h-[70px] rounded-xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.15)] border-[3px] border-white cursor-pointer group z-10 bg-black"
            >
              <img 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end justify-center pb-1">
                <div className="flex items-center gap-1 text-white">
                  ...
                  <span className="text-[10px] font-bold tracking-wide">Layers</span>
                </div>
              </div>
            </div>

            {/* Zoom Controls (Bottom Right) */}
            <div className="absolute bottom-6 right-6 flex flex-col rounded-[10px] overflow-hidden shadow-lg z-10 bg-[#745893]">
              <button 
                onClick={(e) => { e.preventDefault(); setMapZoom(z => Math.min(z + 1, 20)) }}
                className="w-10 h-10 md:w-11 md:h-11 text-white flex items-center justify-center hover:bg-[#62497d] transition text-xl cursor-pointer">
                +
              </button>
              <div className="w-full h-[1px] bg-white/20"></div>
              <button 
                onClick={(e) => { e.preventDefault(); setMapZoom(z => Math.max(z - 1, 1)) }}
                className="w-10 h-10 md:w-11 md:h-11 text-white flex items-center justify-center hover:bg-[#62497d] transition text-2xl leading-none pt-[-2px] cursor-pointer">
                -
              </button>
            </div>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 transition-transform duration-300 ease-out origin-bottom ${showCard ? 'scale-110 drop-shadow-2xl' : 'drop-shadow-xl'}`}>
        <img src={pinSvg} alt="Droga Marker" className="w-[50px] md:w-[60px] h-auto mix-blend-normal" />
      </div>

      {/* THE OVERLAPPING INFO CARD (Toggled via Hover or Click) */}
      {showCard && (
        <div className="absolute left-[90%] md:left-[80%] top-1/2 -translate-y-1/2 ml-4 w-[280px] md:w-[320px] bg-white rounded-2xl shadow-[0_15px_50px_rgba(0,0,0,0.15)] p-5 z-20 cursor-default" onClick={(e) => e.stopPropagation()}>
          
          <div className="flex justify-between items-start mb-2.5">
            <h3 className="text-[#745893] font-bold text-[14.5px] leading-[1.2] pr-2">{data.name}</h3>
            <span className="text-gray-400 text-[11px] font-medium shrink-0 pt-[2px]">{data.dist}</span>
          </div>
          
          <div className="flex items-center gap-1.5 text-gray-500 text-[12px] mb-2.5">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
            {data.away}
          </div>
          
          <div className="flex items-center gap-2 text-[12px] font-bold text-[#222] mb-3">
            <div className="flex text-[#FFF200] text-[13px] tracking-widest gap-0.5">
              <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
            </div>
            <span>{data.rating} <span className="font-light text-gray-400 text-[11px] ml-0.5">({data.users} User)</span></span>
          </div>
          ...
          <div className="flex gap-15 md:gap-20 lg:gap-30">
            ...
            <div>
              ...
              <div className="mt-4 flex items-center gap-3">
                {[
                  <svg key="1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>,
                  <svg key="2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>,
                  <svg key="3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>,
                  <svg key="4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                ].map((icon, i) => (
                  <div key={i} className="w-9 h-9 rounded-full border border-white/80 flex items-center justify-center hover:bg-white hover:text-[#745893] transition cursor-pointer">
                    {icon}
                  </div>
                ))}
              </div>
